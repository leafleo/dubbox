...
public class RegistryContainer {
     ...
     * @return
     */
    public Set<URL> getUrlByProvider() {
    ...
    public Set<String> getHostPortByProvider() {
        Set<String> urls = new HashSet<>();
        for (List<URL> providers : serviceProviders.values()) {
            for (URL url : providers) {
            	urls.add(url.getHost()+":"+url.getPort());
            }
        }
        return urls;
    }
    ...
    public void start() {
        ...
        //subscribeUrl:admin://192.168.2.12?category=providers,consumers&check=false&classifier=*&group=*&interface=*&version=*
